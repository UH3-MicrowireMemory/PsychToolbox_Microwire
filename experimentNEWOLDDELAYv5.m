...
%
% mode1: which instructions to display. MODE_LEARN or MODE_RECOG
%
...
function experimentNEWOLDDELAYv5(variant, blockID, mode, mode2, eyeLinkMode, useCEDRUS)
if nargin<5
...
logDir = 'c:\experiments\logs\';

screenIDToUse=0; %0 main
%screenIDToUse=2;
