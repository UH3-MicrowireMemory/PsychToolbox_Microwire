...
%JAT&MLD sept09, change to hexidecimal TTL using parallel port cable
%
% Modifications in current version by:
% John A. Thompson & Marielle L. Darwin | Sept 9 2021
%===============================

function experimentNEWOLDDELAYv5_MDEyeTrackv2(variant, blockID, mode, mode2, eyeLinkMode, useCEDRUS)
if nargin<5
...
%             end
    ...
    if mode==MODE_RECOG
        ...
        [respType] = getConfidence(fidLog, char, eyeLinkMode);
...
function [respType] = getConfidence(fidLog, char, eyeLinkMode)
setMarkerIDs;
